...
class Fusion2(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.categories = ["combine all the tissues (wm, gm, csf, skull scalp, electrode sheet)"]  # TODO: set categories (folders where the module shows up in the module selector)
